...
from visualizer import postprocess, qtable_directions_map, plot_q_values_map
...
def main():
    ...
    Q, rewards_list, steps_list = q_learn(environment, args.episodes, args.max_steps, args.beta, args.gamma, args.epsilon)
