                ...
                if probabilities.ndim > 1:
                    ...
                    for parent, parent_value in reversed(list(parent_values.items())):
                        ...
                        if parent_value == '?':
                            ...
                            possible_parents = list(marginal_probabilities_dict[parent].keys())
                            weights = list(marginal_probabilities_dict[parent].values())
                            parent_value = random.choices(possible_parents, weights=weights, k=1)[0]
